...
SOURCES = {
    ...
    # === IP-check & VPN-detect → DIRECT (fatyzzz/max-list) ===
    "ip-check": {
        "behavior": "domain",
        "sources": [
            ("ip-check", f"{MAXLIST}/ip-check-formatted.txt"),
        ],
        "extra_domains": []
    },
    "vpndetect": {
        "behavior": "domain",
        "sources": [
            ("vpndetect", f"{MAXLIST}/vpndetect.txt"),
        ],
        "extra_domains": []
    },
...
CLASSICAL_YAML = {
    "proc-games":   "https://raw.githubusercontent.com/legiz-ru/mihomo-rule-sets/main/other/games-direct.yaml",
    "proc-torrent": "https://raw.githubusercontent.com/legiz-ru/mihomo-rule-sets/main/other/torrent-clients.yaml",
    "proc-ru":      "https://raw.githubusercontent.com/legiz-ru/mihomo-rule-sets/main/other/ru-app-list.yaml",
}
